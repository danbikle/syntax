# ~/sites/x2611/script/hamlposts2questions.rb

# This script should loop through 
# ~/sites/x2611/app/views/posts/
...
# ~/sites/x2611/app/views/questions/index.haml

require 'tempfile'

tfh = Tempfile.new('tmpf.haml')
adir = Dir["#{Rails.root}/app/views/posts/*.haml"].sort
adir.each{ |pfn|
